...
if __name__ == '__main__':
    ...
    attack_model_path = Path(os.path.realpath(__file__)).parents[1].joinpath('results', 'attack_by_client', 'first', args.model_type, args.feature_type, model_setting_str+attack_dropout_str, str(args.num_sample), 'private_' + str(args.dataset) + '.pt')
    ...
    if args.leak_layer == 'second' or args.leak_layer == 'fusion':
        ...
        attack_model_path = Path(os.path.realpath(__file__)).parents[1].joinpath('results', 'attack_by_client', 'second', args.model_type, args.feature_type, model_setting_str+attack_dropout_str, str(args.num_sample), 'private_' + str(args.dataset) + '.pt')
    ...
    if args.leak_layer == 'last' or args.leak_layer == 'fusion':
        ...
        attack_model_path = Path(os.path.realpath(__file__)).parents[1].joinpath('results', 'attack_by_client', 'last', args.model_type, args.feature_type, model_setting_str+attack_dropout_str, str(args.num_sample), 'private_' + str(args.dataset) + '.pt')
