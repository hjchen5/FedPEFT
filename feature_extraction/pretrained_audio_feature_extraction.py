...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', default='/home/chenhj/WorkSpaces_python/task001/media/data/sail-data/iemocap')
    parser.add_argument('--save_dir', default='/home/chenhj/WorkSpaces_python/task001/media/data/projects/speech-privacy')
